...
description: Agente de gestão de dependências. Use antes de releases, após alertas de segurança, ou quando o projeto acumula dependências desatualizadas. Especialista em auditar CVEs, licenças, versões desatualizadas e planejar upgrades com breaking changes de forma segura.
