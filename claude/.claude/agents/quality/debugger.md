---
name: debugger
description: Agente de diagnóstico sistemático para bugs difíceis e regressões de performance. Use quando o usuário diz "está dando erro", "diagnostica isso", "está quebrando", "parou de funcionar", ou descreve uma regressão de performance. Especialista em construir loop de feedback confiável, reproduzir o problema e corrigir com teste de regressão.
