---
name: code-health
description: Agente de saúde contínua do código. Use periodicamente ou antes de grandes features para detectar dívida técnica acumulada, complexidade crescente e sinais de degradação. Especialista em gerar relatório priorizado com hotspots e plano de remediação baseado em métricas.
tools: Read, Grep
---
