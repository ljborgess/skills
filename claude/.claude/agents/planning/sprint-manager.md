---
name: sprint-manager
description: Agente de gestão de sprint. Use no início de cada sprint ou quando o backlog está desorganizado. Especialista em organizar backlog, definir capacidade real do time, priorizar itens com critério objetivo e conduzir cerimônias (planning, review, retro) de forma eficiente.
tools: Read, Write
---
