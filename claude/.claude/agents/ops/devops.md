---
name: devops
description: Agente de infraestrutura, CI/CD e operações. Use quando o usuário diz "cria um Dockerfile", "configura o CI/CD", "como fazer deploy de", ou precisa de qualquer automação de infraestrutura. Especialista em pipelines confiáveis, containers seguros e estratégias de deploy sem downtime.
