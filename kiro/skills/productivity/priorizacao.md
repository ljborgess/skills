...
### 3. Matriz Impacto × Esforço (Recomendado para Quick Wins)
```
...
### 4. ICE Score (Recomendado para Experimentos)
```
...
| Nível | Label | SLA de Atenção | Critério |
|-------|-------|----------------|----------|
...
|---|------|----------------|------------|---------------|
| 1 | [item] | RICE: 85 | P1 🟠 | Alto reach, baixo esforço |
| 2 | [item] | Must Have | P1 🟠 | Bloqueante para release |
| 3 | [item] | Could Have | P3 🔵 | Desejável mas não crítico |
...
- [Item] → Adiado porque: [motivo objetivo]
```
